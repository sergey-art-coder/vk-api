...
class NewsModel: Object {
    ...
    @objc dynamic var newsCount: String?
    @objc dynamic var canPost: String?
    @objc dynamic var canSetCategory: String?
    ...
    convenience required init(data: JSON) {
        ...
        self.newsCount = data.count.string
        self.canPost = data.can_post.string
        self.canSetCategory = data.can_set_category.string
        self.newsLikes = data.likes.string
        self.newsType = data.type.string
        self.postType = data.post_type.string
        ...
        self.newsPhoto = data.photo.string
